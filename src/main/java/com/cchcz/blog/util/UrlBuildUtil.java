...
import com.cchcz.blog.constant.ApiUrlConstant;
...
public class UrlBuildUtil {
    ...
    public static String getLocationByIp(String ip, String baiduApiAk) {
        return MessageFormat.format(GET_LOCATION_BY_IP, ApiUrlConstant.BAIDU_API_GET_LOCATION_BY_IP, baiduApiAk, ip);
    }
    ...
    public static String getBaiduPushUrl(String pushType, String site, String baiduPushToken) {
        return MessageFormat.format(BAIDU_PUSH_URL_PATTERN, ApiUrlConstant.BAIDU_PUSH_URL, pushType, site, baiduPushToken);
    }
}
