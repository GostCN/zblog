...
public interface BizBookService {
     ...
     * @param entities
     */
    void insertList(List<Book> entities);
     ...
     * @return
     */
    boolean updateSelective(Book entity);
     ...
     * @return
     */
    Book getByPrimaryKey(Long primaryKey);
     ...
     * @return
     */
    Book getOneByEntity(Book entity);
     ...
     * @return
     */
    List<Book> listByEntity(Book entity);
     ...
     * @return
     */
    PageInfo<Book> findPageBreakByCondition(BookConditionVO vo);
}
