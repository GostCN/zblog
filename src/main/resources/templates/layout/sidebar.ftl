<div class="col-sm-3 blog-sidebar">
    ...
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <a href='https://gitee.com/liuzhaopk' target="_blank" rel="external nofollow"><img
                    src='https://gitee.com/liuzhaopk/zbase-parent/widgets/widget_1.svg?color=07b83f'
                ...
                <div id="feed_widget">
                    <div class="feed-about">
                        <div class="about-main">
                            <div class="about-img"><a href="${config.staticWebSite}/images/weixin.jpg" class="showImage"
                                                      title="微信公众号"><img src="${config.staticWebSite}/images/weixin.jpg"
                                                                         alt="微信公众号"></a></div>
                        ...
                        <ul class="widget-icon">
                            <li class="weixin auto-shake" data-container="body"
                                ...
                                data-content="<img src='${config.staticWebSite}/images/weixin.jpg' style='width: 130px;' alt='QR Code'>">
                                <a class="tag-icon" title="微信" rel="external nofollow"><i class="fa fa-weixin"></i></a>
                            </li>
                            <li class="tqq auto-shake">
                                <a class="tag-icon"
                                   href="javascript:window.open('tencent://message/?uin=1098308189&Site=www.${config.domain}&Menu=yes')"
                                   title="点击QQ联系我" target="blank" rel="external nofollow"><i class="fa fa-qq"></i></a>
                            </li>
                            <li class="tsina auto-shake">
                                <a class="tag-icon" href="http://weibo.com/5593964435" title="点击查看我的微博" target="_blank"
                                   rel="external nofollow"><i class="fa fa-weibo"></i></a>
                            </li>
                            <li class="github auto-shake">
                                <a class="tag-icon" href="https://github.com/GostCN" title="点击查看我的github"
                                   target="_blank" rel="external nofollow"><i class="fa fa-github"></i></a>
                            </li>
                        </ul>
                        <!-- 方案二：列表展示 -->
                        <!--<ul class="list-unstyled">
                            <li><i class="fa fa-info-circle fa-fw"></i>博主：<small>大橙子同学</small></li>
            ...
            <@customTag method="tagsList" pageSize="10">
                <#if tagsList?exists && (tagsList?size > 0)>
                    <#list tagsList as item>
                        <li class="tag-li">
                            <a class="btn btn-default btn-xs" href="${config.siteUrl}/tag/${item.id?c}"
                               title="${item.name?if_exists}" data-toggle="tooltip" data-placement="bottom">
                                ${item.name?if_exists}
                            </a>
                        </li>
                    </#list>
                        ...
                        <a href="${item.sourceUrl}#comment-${item.id?c}" title="${item.briefContent?if_exists}"
                           rel="external nofollow" data-toggle="tooltip" data-placement="bottom">
                            <img alt="${item.nickname?if_exists}" src="${item.avatar?if_exists}"
                                 ...
                                 onerror="this.src='${config.staticWebSite}/images/user.png'"/>
    ...
    <div class="sidebar-module">
        ...
        <ul class="ul-default">
            <@customTag method="siteInfo">
                ...
                <li><i class="fa fa-users fa-fw"></i> 在线人数：<span class="online">8</span>人</li>
                <li><i class="fa fa-users fa-fw"></i> 日访问量：${siteInfo.visitToday!(0)}人</li>
                <li><i class="fa fa-users fa-fw"></i> 累计访问量：${siteInfo.visitAll!(0)}人</li>
   ...
   <#-- <div class="sidebar-module ad">
        <div class="ad-sidebar-bottom blogweb-ad" data-position="sidebar_2">
            <script type="text/javascript">
                /*创建于 2018/7/14*/
                var cpro_id = "u3484253";
            </script>
