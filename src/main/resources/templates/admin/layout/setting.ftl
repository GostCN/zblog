            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <img src="${config.staticWebSite}/upload/2018/07/0jumvolhfagulq4njr1kgrmr0g.jpg" alt=""><#if user?exists>${user.username?if_exists}<#else>管理员</#if>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-sm-12 col-md-12" style="text-align: center;margin: 0 auto;float: initial">
                    <a href="${config.staticWebSite}/assets/images/reward/zfb_code.png" class="showImage" title="支付宝收钱码" rel="external nofollow">
                        <img src="${config.staticWebSite}/assets/images/reward/zfb_code.png" alt="支付宝收钱码" class="img-rounded" style="width: 250px;height: auto;">
                    </a>
                    <a href="${config.staticWebSite}/assets/images/reward/wx_code.png" class="showImage" title="微信收钱码" rel="external nofollow">
                        <img src="${config.staticWebSite}/assets/images/reward/wx_code.png" alt="微信收钱码" class="img-rounded" style="width: 250px;height: auto">
                    </a>
                </div>
