    ...
    <script>
        ...
        $(function () {
            var options = {
                ...
                getInfoUrl: "/admin/roles/get/{id}",
                updateUrl: "/admin/roles/edit",
                removeUrl: "/admin/roles/remove",
                createUrl: "/admin/roles/add",
                saveRolesUrl: "/admin/roles/saveRoleResources",
                columns: [{
                    checkbox: true
                }, {
                    field: 'name',
