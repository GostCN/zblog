                ...
                <div class="x_content">
                    <div class="<#--table-responsive-->">
                        <div class="btn-group hidden-xs" id="toolbar">
                            <a class="btn btn-default" title="发布文章" href="/admin/article/publishMd"> <i
...
<script>
    ...
    function operateFormatter(code, row, index) {
        ...
        var operateBtn = [
            ...
            '<a class="btn btn-xs btn-primary" href="/admin/article/update/' + trId + '"><i class="fa fa-edit"></i>编辑</a>',
            '<a class="btn btn-xs btn-danger btn-remove" data-id="' + trId + '"><i class="fa fa-trash-o"></i>删除</a>',
            '<a class="btn btn-xs btn-success" href="' + appConfig.wwwPath + '/previewArticle/' + trId + '"><i class="fa fa-edit"></i>预览</a>'
        ];
