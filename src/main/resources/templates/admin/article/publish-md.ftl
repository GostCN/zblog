    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>发布文章
                        <small>Markdown编辑器，使用 <#if updateFlag='Y'><a href="/admin/article/update/${id}?type=html">HTML编辑器</a><#else>
                            <a href="/admin/article/publish">HTML编辑器</a></#if></small>
                    </h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                        ...
                        <ul class="wizard_steps">
                            ...
                            <li>
                                <a href="#step-4">
                                    ...
                                    <span class="step_descr"> <small><i
                                            class="fa fa-paper-plane"></i> 发布</small> </span>
                                </a>
                            </li>
                        </ul>
                        <form id="publishForm" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div id="step-2">
                                ...
                                <div class="custom-panel">
                                    <div class="custom-container">
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="title">文章类型
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <select class="form-control" name="typeId" required="required"
                                                        id="typeId" style="width: 120px;"></select>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="title">文章封面
                                                <span class="required">*</span></label>
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <div class="choose-local-img">
                                                    ...
                                                    <input id="cover-img-file" type="file" name="file"
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="mobile">文章标签
                                                <span class="required">*</span></label>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                                <div class="h5"><i class="fa fa-plus-square showContent pointer">
                                                    点击查看</i> <i class="fa fa-refresh fa-1x pointer" id="refressTag">
                                                    刷新</i></div>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="status">文章状态
                                                <span class="required">*</span></label>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                                                <ul class="list-unstyled list-inline">
                                                    <li>
                                                        <input type="radio" class="square" checked name="status"
                                                               value="1"> 发布
                                                    </li>
                                                    <li>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="comment">开启评论
                                                <span class="required">*</span></label>
                                            <div class="col-md-10 col-sm-10 col-xs-10">
                            ...
                            <div id="step-3">
                                ...
                                <div class="custom-panel">
                                    <div class="custom-container">
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="password">摘要
                                                <span class="required">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-2 col-sm-2 col-xs-2" for="password">关键词
                                                <span class="required">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-xs-9">
...
<@footer>
    ...
    <script type="text/javascript" src="${config.staticWebSite}/assets/js/inline-attachment.js"></script>
    <script type="text/javascript" src="${config.staticWebSite}/assets/js/codemirror.inline-attachment.js"></script>
    <script src="${config.staticWebSite}/assets/js/jquery.smartWizard.js"></script>
    <script>
        var op = {
            id: "contentMd",
            uniqueId: "mdEditor_1",
            uploadUrl: "/admin/api/uploadForMd"
        };
        blogadmincore.initMdEditor(op);
        articleId = '${id}';
    </script>
    <script src="${config.staticWebSite}/assets/js/blog-admin.publish-article.js"></script>
    <script>
