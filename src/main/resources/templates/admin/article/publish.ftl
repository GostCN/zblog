    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2>发布文章
                        <small>HTML编辑器，使用 <#if updateFlag='Y'><a
                                href="/admin/article/update/${id}?type=md">Markdown编辑器</a><#else><a
                                href="/admin/article/publishMd">Markdown编辑器</a></#if></small>
                    </h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
        ...
        $(function () {
            if (!articleId) {
                $.alert.confirm("当前已支持markdown编辑器，去试试？", function () {
                    window.location.href ="<#if updateFlag='Y'>/admin/article/update/${id}?type=md<#else>/admin/article/publishMd</#if>";
                }, function () {

        });
            }
            blogadmincore.initWangEditor({
                id: "editor",
                contentId: "content",
