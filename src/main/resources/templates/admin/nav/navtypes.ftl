...
<@footer>
    <script>
        ...
        $(function () {
            var options = {
                modalName: "网址导航类型",
                url: "/admin/navType/list",
                getInfoUrl: "/admin/navType/get/{id}",
                updateUrl: "/admin/navType/edit",
                removeUrl: "/admin/navType/remove",
                createUrl: "/admin/navType/add",
                columns: [
                    {
                        checkbox: true
                    }, {
                        ...
                        formatter: function (code, row, index) {
                            var id = row.id;
                            return '<a href="' + appConfig.wwwPath + '/navType/' + id + '" target="_blank">' + row.name + '</a>';
                        }
                    }, {
                        field: 'icon',
                        title: '图标',
