    ...
    <script>
        ...
        $(function () {
            var options = {
                ...
                getInfoUrl: "/admin/resources/get/{id}",
                updateUrl: "/admin/resources/edit",
                removeUrl: "/admin/resources/remove",
                createUrl: "/admin/resources/add",
                saveRolesUrl: "/admin/resources/saveRoleResources",
                columns: [{
                    checkbox: true
                }, {
                    field: 'name',
