                ...
                <div class="x_content">
                    <div class="<#--table-responsive-->">
                        <div class="btn-group hidden-xs" id="toolbar">
                            <button id="btn_add" type="button" class="btn btn-default" title="新增工具">
                                <i class="fa fa-plus"></i> 新增工具
                            </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="addroleLabel">添加工具</h4>
            </div>
    ...
    <script>
        ...
        $(function () {
            var options = {
                modalName: "工具",
                url: "/admin/tool/list",
                getInfoUrl: "/admin/tool/get/{id}",
                updateUrl: "/admin/tool/edit",
                removeUrl: "/admin/tool/remove",
                createUrl: "/admin/tool/add",
                columns: [
                    {
                        checkbox: true
                    }, {
                        ...
                        formatter: function (code, row, index) {
                            var id = row.id;
                            return '<a href="' + appConfig.wwwPath + '/tool/' + id + '" target="_blank">' + row.name + '</a>';
                        }
                    }, {
                        field: 'description',
                        title: '描述',
