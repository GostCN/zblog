        ...
        <div class="blog-body forbidden">
            <div class="col-md-6 left">
                <div class="error-container text-center">
                    ...
                    <p class="forbidden-img"><img class="img-responsive center-block" src="${config.staticWebSite}/images/forbidden.jpg" alt="你已被拉入黑名单"></p>
            ...
            <div class="col-md-6 right">
                <blockquote class="pull-left">
                    ...
                    <ol>
                        ...
                        <li>2.请联系<a target="_blank" href="javascript:void(0);" title="点击QQ联系我"onclick="window.open('tencent://message/?uin=1098308189&amp;Site=www.${config.domain}&amp;Menu=yes')" rel="external nofollow">网站管理员</a></strong></li>
                    </ol>
                    <div class="clear"></div>
