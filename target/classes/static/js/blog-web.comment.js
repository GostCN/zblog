                ...
                success: function (json) {
                    ...
                    if (!commentList) {
                        ...
                        for (var i = 0, len = commentList.length; i < len; i++) {
                            ...
                            var adminIcon = '';
                            if (comment.admin) {
                                adminIcon = '<img src="' + appConfig.staticPath + '/images/author.png" alt="" class="author-icon" title="管理员">';
                            }
                            ...
                            commentListBox += '<li>' +
                                ...
                                '        <div class="cheader">' +
                                '           <div class="user-img">' + adminIcon + '<img class="userImage" src="' + filterXSS(comment.avatar) + '" onerror="this.src=\'' + appConfig.staticPath + '/images/user.png\'"></div>' +
                                '           <div class="user-info">' +
                                '              <div class="nickname">' +
