<#include "include/music_macros.ftl">

<@header title="音乐馆" keywords="张学友,伍佰,怀旧音乐,80后,90后,轻音乐,纯音乐,节奏,旋律,治愈" description="音乐馆">
</@header>
...
<div class="box">
    <div id="top">音乐馆&nbsp;&nbsp;|&nbsp;&nbsp;music.cchcz.com</div>
    <div id="player">
        <div class="cover"></div>
        <div class="ctrl">
            <div class="tag">
...
<@footer>
    <script src="${config.staticWebSite}/js/blog-web.music.core.js?v=1.0.1" type="text/javascript"></script>
    <script>
        $('.goTop').toTop();
