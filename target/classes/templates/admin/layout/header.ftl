...
<head>
    ...
    <link href="${config.staticWebSite}/assets/css/blog-admin.core.css" rel="stylesheet">
</head>
<body class="nav-md">
        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/admin/" class="site_title"><i class="fa fa-coffee"></i> <span>博客管理后台</span></a>
                </div>
                <div class="clearfix"></div>
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="${config.staticWebSite}/upload/2018/07/0jumvolhfagulq4njr1kgrmr0g.jpg" alt="..." class="img-circle profile_img">
                    </div>
