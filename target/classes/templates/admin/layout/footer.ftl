<footer>
    <div class="pull-right">
        Copyright © 2018 <a href="http://www.cchcz.com" target="_blank">liuzhaopk</a> · Powered by <a href="https://gitee.com/xgost/" title="zblog是一款简洁美观、自适应的Java博客系统..." target="_blank"><strong>zblog</strong></a>. All Rights Reserved.
    </div>
...
<script src="${config.staticWebSite}/assets/js/validator.js"></script>
<script src="${config.staticWebSite}/assets/js/ajaxfileupload.js"></script>
<script src="${config.staticWebSite}/assets/js/jquery-form.js"></script>
<script src="${config.staticWebSite}/assets/js/wangEditor.min.js" type="text/javascript"></script>
<script src="${config.staticWebSite}/assets/js/blog-admin.tool.js"></script>
<script src="${config.staticWebSite}/assets/js/blog-admin.upload-preview.js"></script>
<script src="${config.staticWebSite}/assets/js/blog-admin.core.js"></script>
<script src="${config.staticWebSite}/assets/js/blog-admin.table.js"></script>
</body>
</html>