                ...
                <div class="login_wrapper">
                    <div class="animate form login_form" style="position: relative;">
                        <section class="login_content">
                            <form action="/admin/passport/signin" method="POST" id="login-form">
                                <h1>登录管理系统</h1>
                                <#if message?exists>
                                ...
                                <#if enableKaptcha?exists && enableKaptcha>
                                    <div class="form-group col-xs-6" style="padding-left: 0px;">
                                        <img alt="点击获取验证码" id="img-kaptcha" src="/admin/getKaptcha" style="cursor:pointer;height: 34px;width: 180px;">
                                    </div>
                                ...
                                <div class="separator">
                                    ...
                                    <div>
                                        ...
                                        <p>Copyright © 2018 cchcz.com. All Rights Reserved. </p>
                                    </div>
                                </div>
                            </form>
                        </section>
            ...
            $.ajax({
                ...
                success: function (json) {
                    ...
                    if (json.status == 200) {
                        ...
                        $("#img-kaptcha").attr("src", '/admin/getKaptcha?time=' + new Date().getTime());
                    }
                }
            });
        });
        $("#img-kaptcha").click(function () {
            $(this).attr("src", '/admin/getKaptcha?time=' + new Date().getTime());
        });
