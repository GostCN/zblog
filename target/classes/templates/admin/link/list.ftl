                ...
                columns: [
                    {
                        ...
                        formatter: function (code, row, index) {
                            ...
                            html += '/';
                            if(row.qq){
                                html += '<a href="javascript:void(0);" target="_blank" onclick="window.open(\'tencent://message/?uin=' + row.qq + '&amp;Site=www.cchcz.com&amp;Menu=yes\')" rel="external nofollow"><i class="fa fa fa-qq fa-fw"></i></a>';
                            }else{
                                html += '-';
                            }
                            return html;
