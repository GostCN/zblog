    ...
    <link href="${config.staticWebSite}/css/blog-web.core.css" rel="stylesheet" type="text/css">
    <link href="${config.staticWebSite}/css/blog-web.comment.css" rel="stylesheet" type="text/css">