                        ...
                        <table class="table table-hover table-condensed table-bordered">
                            ...
                            <#if link.disableList>
                                <#list link.disableList as item>
                                    <tr>
                                        <td><img src="${item.favicon}" alt="${item.name}" onerror="this.src='${config.staticWebSite}/images/user.png'" style="width: 20px;" rel="external nofollow"></td>
                                        <td>${item.name}</td>
                                        <td>${item.remark}</td>
                        ...
                        <#list link.indexList as item>
                            <li>
                                <a href="${item.url}" target="_blank" title="${item.description}" data-toggle="tooltip" data-placement="bottom">
                                    <img src="${item.favicon}" alt="${item.name}" onerror="this.src='${config.staticWebSite}/images/user.png'">${item.name}
                                </a>
                            </li>
                        </#list>
                        </ul>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="overflow: hidden">
                ...
                <form class="form-horizontal col-sm-12" role="form" action="/admin/api/autoLink" method="post" id="autoLinkForm" style="padding-left: 15px;">
